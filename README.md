...
3. Enter your Bridge IP address, choose your desired UI settings (Font Size, Scroll), and set your preferred Timeouts.
4. Tap **Save**.
...
To test this watchapp locally without hardcoding your Roon Bridge IP address into the source code:
